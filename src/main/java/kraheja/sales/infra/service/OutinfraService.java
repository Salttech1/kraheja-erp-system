...
public interface OutinfraService {
	...
	ResponseEntity<?> fetchMaintainanceRate(String bldgcode, String wing, String flatnum, String month, String billType);//NS 14.08.2023
	
	ResponseEntity<?> fetchAdminRate(String bldgcode, String wing, String flatnum, String month, String billType);//NS 17.08.2023
	
	ResponseEntity<?> fetchTDSRate(String bldgcode, String wing, String flatnum, String month, String billType);//NS 17.08.2023
