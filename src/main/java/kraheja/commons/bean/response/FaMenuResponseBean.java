...
@NoArgsConstructor
@AllArgsConstructor
public class FaMenuResponseBean {
	...
	private String faFormName;
	
	@JsonProperty(value ="usersup")
	private String faMenuUsersup;
	
	@JsonProperty(value ="sub_menu")
	private List<FaMenuResponseBean> faMenuResponseBeanList;
	
	@JsonProperty(value ="accessRights")
	private List<String> rightsOptionsList;
