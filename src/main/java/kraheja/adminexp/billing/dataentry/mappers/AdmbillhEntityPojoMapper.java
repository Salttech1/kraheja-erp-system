...
public interface AdmbillhEntityPojoMapper {
	...
	public static Function<Object[], List<AdmbillhResponseBean>> fetchAdmbillhEntityPojoMapper = objectArray -> {
		...
		List<Admadvance> admadvanceEntityList = (List<Admadvance>) (Objects
	...
	public static Function<Object[], List<Admbillh>> addAdmbillhEntityPojoMapper = objectArray -> {
		...
		return admbillhRequestBeanList.stream().map(admbillhRequestBean -> {
			return Admbillh.builder().admbillhCK(AdmbillhCK.builder().adblhSer(ser).build())
					...
					.adblhClearacdate(Objects.nonNull(admbillhRequestBean.getClearacdate()) ? LocalDate.parse(
							admbillhRequestBean.getClearacdate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
					...
					.adblhFromdate(Objects.nonNull(admbillhRequestBean.getFromdate()) ? LocalDate.parse(
							admbillhRequestBean.getFromdate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
					...
					.adblhOrderedby(admbillhRequestBean.getOrderedby()).adblhOrigsite(admbillhRequestBean.getOrigsite())
					.adblhOrigsys(admbillhRequestBean.getOrigsys()).adblhPaidamount(admbillhRequestBean.getPaidamount())
					.adblhPaiddate(Objects.nonNull(admbillhRequestBean.getPaiddate()) ? LocalDate.parse(
							admbillhRequestBean.getPaiddate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
					...
					.adblhPassedon(Objects.nonNull(admbillhRequestBean.getPassedon()) ? LocalDate.parse(
							admbillhRequestBean.getPassedon(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
					.adblhProject(admbillhRequestBean.getProject())
					.adblhRundate(Objects.nonNull(admbillhRequestBean.getRundate()) ? LocalDate.parse(
							admbillhRequestBean.getRundate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
					...
					.adblhSuppbilldt(Objects.nonNull(admbillhRequestBean.getSuppbilldt()) ? LocalDate.parse(
							admbillhRequestBean.getSuppbilldt(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
					...
					.adblhTodate(Objects.nonNull(admbillhRequestBean.getTodate()) ? LocalDate.parse(
							admbillhRequestBean.getTodate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
	...
	public static BiFunction<Admbillh, AdmbillhRequestBean, Admbillh> updateAdmbillhEntityPojoMapper = (admbillhEntity,
		...
		admbillhEntity.setAdblhClearacdate(Objects.nonNull(admbillhRequestBean.getClearacdate())
				? LocalDate.parse(admbillhRequestBean.getClearacdate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
		...
		admbillhEntity.setAdblhFromdate(Objects.nonNull(admbillhRequestBean.getFromdate())
				? LocalDate.parse(admbillhRequestBean.getFromdate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
		...
		admbillhEntity.setAdblhOrigsite(
				Objects.nonNull(admbillhRequestBean.getOrigsite()) ? admbillhRequestBean.getOrigsite().trim()
						: admbillhEntity.getAdblhOrigsite());
		...
		admbillhEntity.setAdblhPaiddate(Objects.nonNull(admbillhRequestBean.getPaiddate())
				? LocalDate.parse(admbillhRequestBean.getPaiddate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
		...
		admbillhEntity.setAdblhPassedon(Objects.nonNull(admbillhRequestBean.getPassedon())
				? LocalDate.parse(admbillhRequestBean.getPassedon(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
		...
		admbillhEntity.setAdblhRundate(Objects.nonNull(admbillhRequestBean.getRundate())
				? LocalDate.parse(admbillhRequestBean.getRundate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
				: admbillhEntity.getAdblhRundate());
		// admbillhEntity.setAdblhSite(Objects.nonNull(admbillhRequestBean.getSite()) ?
		// admbillhRequestBean.getSite().trim() : admbillhEntity.getAdblhSite());
		...
		admbillhEntity.setAdblhSuppbilldt(Objects.nonNull(admbillhRequestBean.getSuppbilldt())
				? LocalDate.parse(admbillhRequestBean.getSuppbilldt(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
		...
		admbillhEntity.setAdblhTodate(Objects.nonNull(admbillhRequestBean.getTodate())
				? LocalDate.parse(admbillhRequestBean.getTodate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
				: admbillhEntity.getAdblhTodate());
		admbillhEntity.setAdblhToday(Objects.nonNull(admbillhRequestBean.getToday()) ? admbillhRequestBean.getToday()
				: admbillhEntity.getAdblhToday());
		// admbillhEntity.setAdblhUserid(Objects.nonNull(admbillhRequestBean.getUserid())
		// ? admbillhRequestBean.getUserid().trim() : admbillhEntity.getAdblhUserid());
