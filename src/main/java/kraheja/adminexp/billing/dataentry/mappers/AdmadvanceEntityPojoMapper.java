...
public interface AdmadvanceEntityPojoMapper {
	...
	public static Function<Object[], List<AdmadvanceResponseBean>> fetchAdmadvanceEntityPojoMapper = objectArray -> {
		...
		return admadvanceEntityList.stream().map(admadvanceEntity -> {
			return AdmadvanceResponseBean.builder().ser(admadvanceEntity.getAdmadvanceCK().getAdvnSer())
					...
					.date(Objects.nonNull(admadvanceEntity.getAdvnDate())
							? admadvanceEntity.getAdvnDate().format(CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
							: null)
					...
					.paiddate(Objects.nonNull(admadvanceEntity.getAdvnPaiddate())
							? admadvanceEntity.getAdvnPaiddate().format(CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
							: null)
					...
					.passedon(Objects.nonNull(admadvanceEntity.getAdvnPassedon())
							? admadvanceEntity.getAdvnPassedon().format(CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
							: null)
					.pinvdate(Objects.nonNull(admadvanceEntity.getAdvnPinvdate())
							? admadvanceEntity.getAdvnPinvdate().format(CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
							: null)
	...
	public static Function<Object[], List<Admadvance>> addAdmadvancePojoEntityMapper = objectArray -> {
		...
		return admadvanceRequestBeanList.stream().map(admadvanceRequestBean -> {
			return Admadvance.builder()
					.admadvanceCK(AdmadvanceCK.builder().advnSer(admadvanceRequestBean.getSer()).build())
					...
					.advnDate(Objects.nonNull(admadvanceRequestBean.getDate()) ? LocalDate.parse(
							admadvanceRequestBean.getDate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
					...
					.advnPaidamount(Objects.nonNull(admadvanceRequestBean.getPaidamount())
							...
							: BigInteger.ZERO.doubleValue())
					.advnPaiddate(Objects.nonNull(admadvanceRequestBean.getPaiddate()) ? LocalDate.parse(
							admadvanceRequestBean.getPaiddate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
					...
					.advnPassedon(Objects.nonNull(admadvanceRequestBean.getPassedon()) ? LocalDate.parse(
							admadvanceRequestBean.getPassedon(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
					.advnPinvdate(Objects.nonNull(admadvanceRequestBean.getPinvdate()) ? LocalDate.parse(
							admadvanceRequestBean.getPinvdate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER) : null)
	...
	public static BiFunction<Admadvance, AdmadvanceRequestBean, Admadvance> updateAdmadvanceEntityPojoMapper = (
		...
		admadvanceEntity.setAdvnDate(Objects.nonNull(admadvanceRequestBean.getDate())
				? LocalDate.parse(admadvanceRequestBean.getDate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
		...
		admadvanceEntity.setAdvnPaiddate(Objects.nonNull(admadvanceRequestBean.getPaiddate())
				? LocalDate.parse(admadvanceRequestBean.getPaiddate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
		...
		admadvanceEntity.setAdvnPassedon(Objects.nonNull(admadvanceRequestBean.getPassedon())
				? LocalDate.parse(admadvanceRequestBean.getPassedon(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
				: admadvanceEntity.getAdvnPassedon());
		admadvanceEntity.setAdvnPinvdate(Objects.nonNull(admadvanceRequestBean.getPinvdate())
				? LocalDate.parse(admadvanceRequestBean.getPinvdate(), CommonConstraints.INSTANCE.DDMMYYYY_FORMATTER)
