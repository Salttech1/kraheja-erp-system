...
// Developed By  - 	Dev4
// Developed on - 05-06-23
// Mode  - Data Entry
// Purpose - Cbillh Entry / Edit
...
@NoArgsConstructor
@AllArgsConstructor
public class CbillhResponseBean {

	private Double advancetoadj ;
	...
	private List<CbilldResponseBean> cbilldResponseBean;
}