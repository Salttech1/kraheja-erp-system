...
@Repository
public interface LoancompanyaddressRepository extends JpaRepository<Loancompanyaddress, LoancompanyaddressCK>, CrudRepository<Loancompanyaddress, LoancompanyaddressCK>{
